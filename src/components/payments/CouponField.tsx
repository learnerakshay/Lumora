      ...
      <div className="rounded-xl border border-emerald-800/50 bg-emerald-950/25 p-3.5 shadow-[0_0_24px_rgba(16,185,129,0.08)]">
        <div className="flex items-center justify-between gap-3">
          ...
          <button
            ...
            disabled={disabled}
            className="flex items-center gap-1 rounded-lg px-2 py-1 text-[11px] font-medium text-emerald-200/70 transition hover:bg-emerald-900/40 hover:text-emerald-100 disabled:opacity-50"
          >
            <X className="h-3 w-3" />
            Remove
          </button>
    ...
    <div>
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="flex shrink-0 items-center gap-1.5 rounded-xl border border-slate-700 bg-slate-800 px-4 py-2 text-xs font-semibold text-slate-200 transition hover:bg-slate-700 disabled:cursor-not-allowed disabled:opacity-50"
        >
