      ...
      <div className="max-w-7xl mx-auto space-y-16 relative z-10">
        ...
        <div className="relative">
          <div
            ref={connectorRef}
            aria-hidden="true"
            className="absolute left-[16%] right-[16%] top-1/2 hidden h-px bg-gradient-to-r from-sky-500/10 via-sky-300/60 to-cyan-500/10 lg:block"
          >
            <span className="workflow-runner" />
          </div>
        <div ref={flowRef} className="relative grid grid-cols-1 items-stretch gap-8 lg:grid-cols-3">
          {/* STEP 1: COLLECT */}
          <div className="landing-card group flex flex-col justify-between space-y-6 rounded-2xl border border-slate-800/90 bg-[#101826]/95 p-6 shadow-xl">
